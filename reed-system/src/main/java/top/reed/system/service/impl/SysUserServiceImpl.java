...
import top.reed.common.utils.bean.BeanValidators;
...
import top.reed.system.domain.SysUserPost;
import top.reed.system.domain.SysUserRole;
import top.reed.system.mapper.*;
...
public class SysUserServiceImpl implements ISysUserService {
    ...
    public void checkUserAllowed(SysUser user) {
        if (StringUtils.isNotNull(user.getUserId()) && user.isSuper()) {
