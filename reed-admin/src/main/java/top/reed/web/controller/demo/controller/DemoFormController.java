...
import top.reed.common.core.domain.CxSelect;
import top.reed.common.json.JSONObject;
import top.reed.common.json.JSONObject.JSONArray;
...
public class DemoFormController {
    ...
    static {
        users.add(new UserFormModel(1, "1000001", "测试1", "15311499133"));
        users.add(new UserFormModel(2, "1000002", "测试2", "15311499133"));
        users.add(new UserFormModel(3, "1000003", "测试3", "15311499133"));
        users.add(new UserFormModel(4, "1000004", "测试4", "15311499133"));
        users.add(new UserFormModel(5, "1000005", "测试5", "15311499133"));
    }
    ...
    public String progress_bars() {
        return "demo/form/progress_bars";
    }
    ...
    public String localRefreshTask(String fragment, String taskName, ModelMap modelMap) {
        ...
        list.add(item);
        modelMap.put("tasks", list);
        return "demo/form/localrefresh::" + fragment;
    }
