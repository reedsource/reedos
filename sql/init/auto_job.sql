...
values (1, '系统默认（无参）', 'DEFAULT', '1', 'ryTask.ryNoParams', '0/10 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, ''),
       (2, '系统默认（有参）', 'DEFAULT', '1', 'ryTask.ryParams(''ry'')', '0/15 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, ''),
       (3, '系统默认（多参）', 'DEFAULT', '1', 'ryTask.ryMultipleParams(''ry'', true, 2000L, 316.50D, 100)', '0/20 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, '');