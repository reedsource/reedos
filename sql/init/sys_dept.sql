...
values (100, 0, '0', 'ReedOS', 0, 'reed', '15311499133', 'reedsource@189.cn', '0', '0', 'admin', sysdate(), '', null),
       (110, 100, '0,100', '管理部', 1, 'reed', '15311499133', 'reedsource@189.cn', '0', '0', 'admin', sysdate(), '',
        null),
       (111, 110, '0,100,110', '系统管理', 1, 'reed', '15311499133', 'reedsource@189.cn', '0', '0', 'admin', sysdate(),
        '', null),
       (120, 100, '0,100', '市场部', 1, 'reed', '15311499133', 'reedsource@189.cn', '0', '0', 'admin', sysdate(), '',
        null),
       (121, 120, '0,100,120', '会员', 1, 'reed', '15311499133', 'reedsource@189.cn', '0', '0', 'admin', sysdate(), '',
        null),
       (122, 120, '0,100,120', '默认用户', 1, 'reed', '15311499133', 'reedsource@189.cn', '0', '0', 'admin', sysdate(),
        '', null);