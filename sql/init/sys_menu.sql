...
values (4000000, '内容管理', 0, 4, '#', 'menuItem', 'M', '0', '1', null, 'fa fa-address-card-o', 'admin', sysdate(), '', null, ''),
       ...
       (4100802, '评论列表', 4100800, 2, '#', '', 'F', '0', '1', 'cms:comment:add', '#', 'admin', sysdate(), 'admin', sysdate(), ''),
       (4100803, '评论列表', 4100800, 3, '#', '', 'F', '0', '1', 'cms:comment:edit', '#', 'admin', sysdate(), 'admin', sysdate(), ''),
       (4100804, '评论列表', 4100800, 4, '#', '', 'F', '0', '1', 'cms:comment:remove', '#', 'admin', sysdate(), 'admin', sysdate(), ''),
       (4100805, '评论列表', 4100800, 5, '#', '', 'F', '0', '1', 'cms:comment:export', '#', 'admin', sysdate(), 'admin', sysdate(), ''),
       (4100900, '励志短语', 4100000, 9, '/cms/shortWords', 'menuItem', 'C', '0', '1', 'cms:shortWords:view', '#', 'admin', sysdate(), '', null, ''),
       (4100901, '励志列表', 4100900, 1, '#', '', 'F', '0', '1', 'cms:shortWords:list', '#', 'admin', sysdate(), 'admin', sysdate(), ''),
       (4100902, '励志列表', 4100900, 2, '#', '', 'F', '0', '1', 'cms:shortWords:add', '#', 'admin', sysdate(), 'admin', sysdate(), ''),
       (4100903, '励志列表', 4100900, 3, '#', '', 'F', '0', '1', 'cms:shortWords:edit', '#', 'admin', sysdate(), 'admin', sysdate(), ''),
       (4100904, '励志列表', 4100900, 4, '#', '', 'F', '0', '1', 'cms:shortWords:remove', '#', 'admin', sysdate(), 'admin', sysdate(), ''),
       (4100905, '励志列表', 4100900, 5, '#', '', 'F', '0', '1', 'cms:shortWords:export', '#', 'admin', sysdate(), 'admin', sysdate(), ''),
