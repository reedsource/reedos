...
values (4000000, '内容管理', 0, 4, '#', 'menuItem', 'M', '0', '1', null, 'fa fa-address-card-o', 'admin', sysdate(), '', null, ''),
       ...
       (4100201, '登录页面添加', 4100000, 1, '#', '', 'F', '0', '1', 'cms:loginPage:add', '#', 'admin', sysdate(), '', null, ''),
       (4100202, '登录页面修改', 4100000, 2, '#', '', 'F', '0', '1', 'cms:loginPage:edit', '#', 'admin', sysdate(), '', null, ''),
       (4100203, '登录页面删除', 4100000, 3, '#', '', 'F', '0', '1', 'cms:loginPage:remove', '#', 'admin', sysdate(), '', null, ''),
       (4100204, '登录页面导出', 4100000, 4, '#', '', 'F', '0', '1', 'cms:loginPage:export', '#', 'admin', sysdate(), '', null, ''),
       ...
       (4100700, '站内消息', 4100000, 7, '/cms/siteMsg', 'menuItem', 'C', '0', '1', 'cms:siteMsg', '#', 'admin', sysdate(), '', null, ''),
