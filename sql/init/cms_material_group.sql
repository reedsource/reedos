...
INSERT INTO reedos.cms_material_group (group_id, parent_id, dept_id, group_name, description, sort, user_id, create_by, create_time)
VALUES (1, null, '100', '默认分组', '默认', 1, '1', 'admin', sysdate()),
       (2, null, '103', '研发分组', '研发', 2, '1', 'admin', sysdate()),
       (3, null, '105', '测试分组', '测试部门', 3, '1', 'admin', sysdate());
