...
values (1, 111, 'super', '超级管理员', '00', 'reedsource@189.cn', '15311499133', '1', '',
        'f58217d6f1c6f130019f183424468eb2', 'e09ee2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(),
        '', null, '管理员'),
       (2, 111, 'admin', '系统管理', '00', 'reedsource@189.cn', '15311499133', '1', '',
        'f58217d6f1c6f130019f183424468eb2', 'e09ee2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(),
        '', null, '系统管理'),
       (3, 121, 'reed', '会员', '00', 'reedsource@189.cn', '15311499133', '1', '', 'f58217d6f1c6f130019f183424468eb2',
        'e09ee2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '系统会员'),
       (4, 122, 'default', '默认用户', '00', 'reedsource@189.cn', '15311499133', '1', '',
        'f58217d6f1c6f130019f183424468eb2', 'e09ee2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(),
        '', null, '默认用户');